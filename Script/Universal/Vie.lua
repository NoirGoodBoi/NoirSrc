...
PacksTab:CreateButton({ Name = "Piano Việt Nam", Callback = function() loadstring(game:HttpGet("https://gist.githubusercontent.com/vukhanhtoan2907-lab/705658996e60d919a22cdc5dc0ce90d9/raw/gistfile1.txt"))() end })
PacksTab:CreateButton({ Name = "Piano Nước Ngoài (key: 471494)", Callback = function() loadstring(game:HttpGet("https://hellohellohell0.com/talentless-raw/TALENTLESS.lua", true))() end })
